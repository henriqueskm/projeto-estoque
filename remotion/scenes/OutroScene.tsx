...
export function OutroScene() {
  ...
  return (
    <div style={{position: "absolute", inset: 0, display: "grid", placeItems: "center", overflow: "hidden", opacity: interpolate(frame, [0, 18], [0, 1], {extrapolateRight: "clamp"}), background: "radial-gradient(circle at center, #263139 0%, #171d21 52%, #0d1114 100%)", color: "white"}}>
      <div style={{textAlign: "center", opacity: progress, translate: `0 ${interpolate(progress, [0, 1], [32, 0])}px`}}>
