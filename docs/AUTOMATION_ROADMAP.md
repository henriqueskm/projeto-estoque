...
| NK-ORD-007 | Retirada com entrada automática no Estoque | Auditoria e arquitetura | NK-ORD-006; retirada e entrada oficiais | C | WAITING_ARCHITECTURE_REVIEW | `agent/pickup-auto-stock-audit` | Pendente | Crítico | Arquitetura e futura operação | Exige worker PostgreSQL composto: somente o delta recém-retirado entra atomicamente; backlog permanece no NK-ORD-006 |
