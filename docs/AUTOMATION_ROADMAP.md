...
| MIG-ORD-007A | Atomic pickup + stock entry | Migration | NK-ORD-007 aprovado | C | WAITING_DB_REVIEW | `agent/atomic-pickup-stock-entry` | Pendente | Crítico | Revisão de banco e aplicação remota futura | Implementada e validada somente no Supabase Local; não aplicada remotamente |
