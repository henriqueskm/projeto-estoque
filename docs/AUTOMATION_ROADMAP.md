...
| MIG-SAF-001 | Fundação de banco do Portal da Safisa | Migration | NK-SAF-001; MIG-BASE-001 | C | WAITING_HUMAN_REVIEW | `agent/safisa-portal-migration` | [#5](https://github.com/henriqueskm/projeto-estoque/pull/5) | Crítico | Revisão humana do SQL validado | Testes dinâmicos locais e concorrência aprovados; revisar PR draft, mantendo aplicação remota bloqueada |
