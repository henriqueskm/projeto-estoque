...
| MIG-BASE-001 | Baseline reproduzível do estado atual | Infraestrutura local | MIG-HIST-001 | B | WAITING_HUMAN_REVIEW | `agent/current-state-baseline` | [#7](https://github.com/henriqueskm/projeto-estoque/pull/7) | Alto | Revisão do baseline | Validar PR draft; depois retomar PR #5 com novo timestamp |
