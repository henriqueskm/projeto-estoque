...
| NK-ORD-007 | Retirada com entrada automática no Estoque | Auditoria e arquitetura | NK-ORD-006; retirada e entrada oficiais | C | ARCHITECTURE_APPROVED | `agent/pickup-auto-stock-audit` | [#16](https://github.com/henriqueskm/projeto-estoque/pull/16) | Crítico | Arquitetura aprovada | Worker PostgreSQL composto aprovado: somente o delta recém-retirado entra atomicamente; backlog permanece no NK-ORD-006 |
| MIG-ORD-007A | Atomic pickup + stock entry | Migration | NK-ORD-007 aprovado | C | DB_REVIEW_APPROVED / NOT_APPLIED_REMOTE | `agent/atomic-pickup-stock-entry` | [#17](https://github.com/henriqueskm/projeto-estoque/pull/17) | Crítico | Aplicação remota coordenada futura | Migration mesclada e validada somente no Supabase Local; permanece pendente no remoto |
| NK-ORD-007B | Aplicação da retirada + entrada automática | Aplicação | MIG-ORD-007A aprovada e não aplicada remotamente | B | IMPLEMENTED / WAITING_HUMAN_VISUAL_REVIEW | `agent/atomic-pickup-stock-entry-app` | [#18](https://github.com/henriqueskm/projeto-estoque/pull/18) | Crítico | Visual; aplicação coordenada da migration antes de teste operacional | UI e Assistente usam `ready - picked`, bloqueiam redução, mostram backlog separado e consomem uma única RPC composta |
