...
| NK-SAF-004 | Alertas internos de retirada Safisa | Aplicação | NK-SAF-003 | A | WAITING_HUMAN_REVIEW | `agent/safisa-pickup-alerts-implementation` | Pendente | Médio | Validação visual humana | Alertas derivados por `ready_quantity - picked_quantity`; sino, Home e Pedidos implementados sem migration |
