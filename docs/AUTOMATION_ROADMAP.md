...
| MIG-SAF-001 | Fundação de banco do Portal da Safisa | Migration | NK-SAF-001 | C | WAITING_HUMAN_REVIEW | `agent/safisa-portal-migration` | Draft pendente | Crítico | Revisão do SQL obrigatória | Revisar a migration local; aplicação remota continua bloqueada |
