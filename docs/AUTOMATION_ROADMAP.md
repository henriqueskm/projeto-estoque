...
| NK-SAF-001 | Auditoria e especificação do Portal da Safisa — prioridade alta do piloto | Auditoria e arquitetura | NK-AUTO-001; Pedidos existentes | C/D | WAITING_HUMAN_REVIEW | `agent/safisa-portal-audit` | Pendente | Crítico | Arquitetura, segurança e regras | Aprovar decisões de acesso, publicação, correção e retirada antes de criar migration |
