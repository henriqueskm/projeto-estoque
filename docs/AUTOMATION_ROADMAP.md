...
| NK-SAF-003 | Safisa automática por Pedido | Migration e aplicação | MIG-SAF-001; MIG-SAF-003; NK-SAF-002 | B | WAITING_HUMAN_REVIEW | `agent/safisa-automatic-orders` | Pendente | Crítico | Revisão humana do PR draft | Todo Pedido é Safisa-managed automaticamente; sem publicação manual; conclusão e cancelamento auditados |
