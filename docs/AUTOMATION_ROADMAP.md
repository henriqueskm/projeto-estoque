...
| NK-SAF-004 | Alertas internos de retirada Safisa | Auditoria e documentação | NK-SAF-003 | A | WAITING_HUMAN_REVIEW | `agent/safisa-pickup-alerts` | Pendente | Médio | Revisão da arquitetura e UX propostas | Derivar alertas atuais por `ready_quantity - picked_quantity`; nenhuma migration é necessária |
