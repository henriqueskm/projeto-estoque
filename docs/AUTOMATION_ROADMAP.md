...
| NK-ASM-002 | Implementação da montagem pela Assistente | Aplicação | NK-ASM-001 B | B | WAITING_HUMAN_REVIEW | `agent/assistant-assembly` | [#3](https://github.com/henriqueskm/projeto-estoque/pull/3) | Crítico | Visual e operacional | Revisar PR draft e validar sem confirmar montagem |
