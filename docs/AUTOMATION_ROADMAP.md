...
| NK-DIS-002 | Implementação da desmontagem pela Assistente | Aplicação | NK-DIS-001 B | B | WAITING_HUMAN_VISUAL_REVIEW | `agent/assistant-disassembly` | Pendente | Crítico | Visual e operacional | Prévia e confirmação segura implementadas localmente; aguarda revisão visual |
