...
| NK-ORD-004 | Finalização de Pedido | Aplicação | NK-ORD-001 | B | WAITING_HUMAN_VISUAL_REVIEW | `agent/assistant-order-finalization` | Pendente | Crítico | Visual e operacional | Prévia e confirmação segura implementadas sobre a RPC oficial; aguarda revisão humana |
