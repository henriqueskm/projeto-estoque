...
export default async function OutboundPage() {
  ...
  return (
    <main data-nk-perf-ready="/saida" className="mx-auto w-full max-w-7xl px-3 py-4 sm:px-6 sm:py-7 lg:px-8">
      <Link
        href="/"
      ...
      <section className="mb-5 flex items-center gap-3 border-b border-border-neutral pb-4 sm:mb-6 sm:gap-4 sm:pb-5">
        <span className="flex size-11 shrink-0 items-center justify-center rounded-2xl bg-red-100 text-red-800 sm:size-12">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-1 max-w-2xl text-sm font-semibold text-text-muted">
            Selecione itens, confira os saldos e revise antes de confirmar.
          </p>
        </div>
      </section>
